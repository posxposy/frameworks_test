...
class HXCPP_CLASS_ATTRIBUTES  Mathf_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.math.Mathf")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("Mathf","\x7e","\xbd","\x50","\x96"); }
		...
		static Float SmoothStep( Float p_a,Float p_b,Float p_ratio);
		static Dynamic SmoothStep_dyn();

		static Float PerlinStep( Float p_a,Float p_b,Float p_ratio);
		static Dynamic PerlinStep_dyn();

		static Float Hermite( Float p_a,Float p_b,Float p_ma,Float p_mb,Float p_ratio);
		static Dynamic Hermite_dyn();

		static int LerpInt( int p_a,int p_b,Float p_ratio);
		static Dynamic LerpInt_dyn();

		static int SmoothStepInt( int p_a,int p_b,Float p_ratio);
		static Dynamic SmoothStepInt_dyn();

		static int PerlinStepInt( int p_a,int p_b,Float p_ratio);
		static Dynamic PerlinStepInt_dyn();

		static Float Frac( Float p_v,hx::Null< bool >  p_signed);
