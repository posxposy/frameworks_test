...
class HXCPP_CLASS_ATTRIBUTES  Color_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.math.Color")
...
void __GetFields(Array< ::String> &outFields);
		...
		static ::haxor::math::Color transparent;
		static ::haxor::math::Color get_transparent( );
