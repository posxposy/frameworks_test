...
class HXCPP_CLASS_ATTRIBUTES  AABB3_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.math.AABB3")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("AABB3","\x93","\xe1","\x34","\x98"); }
		...
		static ::haxor::math::AABB3 Parse( ::String p_data,::String p_delimiter);
