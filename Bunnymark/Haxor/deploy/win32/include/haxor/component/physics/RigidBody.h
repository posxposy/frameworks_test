...
class HXCPP_CLASS_ATTRIBUTES  RigidBody_obj : public ::haxor::component::Behaviour_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.component.physics.RigidBody")
...
void __GetFields(Array< ::String> &outFields);
		...
		virtual Void AddTorque( ::haxor::math::Vector3 p_torque,hx::Null< int >  p_mode);
		Dynamic AddTorque_dyn();

		virtual Void AddForce( ::haxor::math::Vector3 p_force,hx::Null< int >  p_mode);
