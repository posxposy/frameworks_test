...
class CursorMode_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxor.graphics.CursorMode","\x10","\x68","\x0b","\x49"); }
		::String __ToString() const { return HX_HCSTRING("CursorMode.","\x95","\x14","\x6c","\x79") + tag; }
