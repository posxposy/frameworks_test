...
class HXCPP_CLASS_ATTRIBUTES  GL_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.graphics.GL")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		static int VIEWPORT;
		static int ZERO;
		static bool VAO_ENABLED;
		static bool TEXTURE_SRGB;
		static int SRGB;
		static int SRGB_ALPHA;
		...
		static int MAX_COMBINED_TEXTURE;
		static int MAX_FRAGMENT_UNIFORM_LENGTH;
		static int MAX_VERTEX_UNIFORM_LENGTH;
		static int MAX_VERTEX_TEXTURES;
		static int get_MAX_UNIFORM_BONES( );
		static Dynamic get_MAX_UNIFORM_BONES_dyn();

		static bool BONE_TEXTURE;
		static bool VS_FLOAT_HIGHP;
		static bool VS_INT_HIGHP;
		static bool FS_FLOAT_HIGHP;
		static bool FS_INT_HIGHP;
		static int _NULL;
		static int INVALID;
		...
		static Void BindVAO( int p_id);
		static Dynamic BindVAO_dyn();
		...
		static Void DeleteVAO( int p_id);
		static Dynamic DeleteVAO_dyn();
		...
		static Void VertexAttrib1f( int p_location,Float p_x);
		static Dynamic VertexAttrib1f_dyn();

		static Void VertexAttrib2f( int p_location,Float p_x,Float p_y);
