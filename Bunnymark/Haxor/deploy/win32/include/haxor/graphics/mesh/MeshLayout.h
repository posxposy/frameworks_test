...
class HXCPP_CLASS_ATTRIBUTES  MeshLayout_obj : public ::haxor::graphics::mesh::Mesh_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.graphics.mesh.MeshLayout")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("MeshLayout","\x97","\x20","\x53","\x33"); }
