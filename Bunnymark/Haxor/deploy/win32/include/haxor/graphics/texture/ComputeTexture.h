...
class HXCPP_CLASS_ATTRIBUTES  ComputeTexture_obj : public ::haxor::graphics::texture::Texture2D_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.graphics.texture.ComputeTexture")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< ComputeTexture_obj > __new(int p_width,int p_height,int p_format);
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("ComputeTexture","\x44","\x2a","\x29","\x06"); }
