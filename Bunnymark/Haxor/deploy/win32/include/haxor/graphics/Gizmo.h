...
class HXCPP_CLASS_ATTRIBUTES  Gizmo_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.graphics.Gizmo")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("Gizmo","\x5a","\x89","\x37","\x27"); }
