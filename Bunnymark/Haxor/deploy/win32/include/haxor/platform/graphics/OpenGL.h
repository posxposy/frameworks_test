...
class HXCPP_CLASS_ATTRIBUTES  OpenGL_obj : public ::haxor::platform::windows::graphics::WinGL_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.platform.graphics.OpenGL")
...
Dynamic __Field(const ::String &inString, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("OpenGL","\x8f","\xbc","\x28","\x56"); }
