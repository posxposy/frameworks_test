...
class HXCPP_CLASS_ATTRIBUTES  BitmapLoader_obj : public ::haxor::platform::windows::net::HTTPLoader_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.platform.windows.net.BitmapLoader")
...
static bool __SetStatic(const ::String &inString, Dynamic &ioValue, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("BitmapLoader","\x82","\x35","\xa1","\x2b"); }
