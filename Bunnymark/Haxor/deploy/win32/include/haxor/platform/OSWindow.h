...
class HXCPP_CLASS_ATTRIBUTES  OSWindow_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.platform.OSWindow")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("OSWindow","\x34","\xc0","\x27","\xa9"); }
