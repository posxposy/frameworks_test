...
class HXCPP_CLASS_ATTRIBUTES  RendererContext_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.context.RendererContext")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("RendererContext","\xcc","\x7e","\xdf","\x3f"); }
		...
		virtual Void UpdateSkinning( ::haxor::component::SkinnedMeshRenderer smr,bool jf);
		Dynamic UpdateSkinning_dyn();
