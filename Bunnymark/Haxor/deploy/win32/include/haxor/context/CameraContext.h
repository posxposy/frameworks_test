...
class HXCPP_CLASS_ATTRIBUTES  CameraContext_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.context.CameraContext")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("CameraContext","\xaa","\x15","\x65","\x69"); }

		::haxor::context::UID cid;
		Array< ::Dynamic > list;
		Array< ::Dynamic > front;
		Array< ::Dynamic > back;
		::haxor::graphics::material::Material skybox_material;
