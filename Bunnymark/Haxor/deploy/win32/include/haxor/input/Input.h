...
class HXCPP_CLASS_ATTRIBUTES  Input_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.input.Input")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		static Array< ::Dynamic > log;
		static Float timeout;
		static Float m_timeout_elapsed;
		...
		static Array< ::Dynamic > Filter( int p_code);
		static Dynamic Filter_dyn();

		static bool MultiHit( int p_code,hx::Null< int >  p_count,hx::Null< Float >  p_timeout,hx::Null< bool >  p_clear);
		static Dynamic MultiHit_dyn();
