...
class HXCPP_CLASS_ATTRIBUTES  KeyCode_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.input.KeyCode")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("KeyCode","\x4c","\x4a","\xef","\x68"); }
