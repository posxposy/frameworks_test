...
class HXCPP_CLASS_ATTRIBUTES  ColladaMaterial_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.io.file.ColladaMaterial")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("ColladaMaterial","\x19","\x80","\x26","\x3a"); }
