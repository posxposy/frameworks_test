...
class HXCPP_CLASS_ATTRIBUTES  ColladaFile_obj : public ::haxor::io::file::AssetXML_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.io.file.ColladaFile")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("ColladaFile","\xee","\xd0","\x65","\xff"); }
		...
		virtual ::haxor::component::MeshRenderer CreateMeshRenderer( ::haxor::core::Entity e,::String msh,::haxor::io::file::ColladaPrimitive cp,::hx::Class t,::haxor::io::file::ColladaController cc);
		...
		virtual Array< ::Dynamic > ParseInputList( ::Xml p,::Xml n,hx::Null< bool >  smart);
