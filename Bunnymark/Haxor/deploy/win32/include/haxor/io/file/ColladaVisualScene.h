...
class HXCPP_CLASS_ATTRIBUTES  ColladaVisualScene_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.io.file.ColladaVisualScene")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("ColladaVisualScene","\x3a","\x3e","\xae","\x72"); }
