...
class HXCPP_CLASS_ATTRIBUTES  ColladaController_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.io.file.ColladaController")
...
void __GetFields(Array< ::String> &outFields);
		...
		::String __ToString() const { return HX_HCSTRING("ColladaController","\x8e","\xfc","\x64","\x8b"); }
