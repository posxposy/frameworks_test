...
class HXCPP_CLASS_ATTRIBUTES  Buffer_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="haxor.io.Buffer")
...
void __GetFields(Array< ::String> &outFields);
		...
		virtual Array< int > ToByteArray( );
		Dynamic ToByteArray_dyn();
		...
		static ::haxor::io::Buffer Parse( ::String p_data,::String p_delimiter,hx::Null< bool >  p_is_byte);
