...
class TextureType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxor.core.TextureType","\x32","\x27","\xe4","\x08"); }
		::String __ToString() const { return HX_HCSTRING("TextureType.","\x79","\x69","\x7d","\xdb") + tag; }
