...
class HXCPP_CLASS_ATTRIBUTES  RenderEngine_obj : public hx::Object{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=false,const char *inName="haxor.core.RenderEngine")
...
static bool __GetStatic(const ::String &inString, Dynamic &outValue, hx::PropertyAccess inCallProp);
		...
		::String __ToString() const { return HX_HCSTRING("RenderEngine","\xd8","\x97","\xec","\x33"); }

		static Dynamic onfinish;
		static Dynamic &onfinish_dyn() { return onfinish;}
		static Void Render( );
