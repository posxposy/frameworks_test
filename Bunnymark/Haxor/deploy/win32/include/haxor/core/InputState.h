...
class InputState_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxor.core.InputState","\x4a","\x96","\x17","\x94"); }
		::String __ToString() const { return HX_HCSTRING("InputState.","\x87","\x4c","\x62","\xdf") + tag; }
