...
class ApplicationProtocol_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxor.core.ApplicationProtocol","\xc5","\x88","\x95","\xd3"); }
		::String __ToString() const { return HX_HCSTRING("ApplicationProtocol.","\x86","\xed","\x1f","\x9f") + tag; }
