...
class ColliderType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		::String GetEnumName( ) const { return HX_HCSTRING("haxor.core.ColliderType","\x71","\xaf","\xbc","\x07"); }
		::String __ToString() const { return HX_HCSTRING("ColliderType.","\x40","\xb4","\xf9","\xc7") + tag; }
