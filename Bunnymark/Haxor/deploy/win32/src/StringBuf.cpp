...
{
HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/StringBuf.hx",29,0x02c752cc)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("StringBuf","add",0xaa9f1675,"StringBuf.add","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/StringBuf.hx",40,0x02c752cc)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(41)
		Array< ::String > tmp = this->b;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(41)
