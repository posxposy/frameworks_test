...
{
HX_STACK_FRAME("Xml","new",0x2e496e29,"Xml.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",305,0x4070b816)
HX_STACK_THIS(this)
...
::String Xml_obj::get( ::String att){
	HX_STACK_FRAME("Xml","get",0x2e441e5f,"Xml.get","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",166,0x4070b816)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("Xml","set",0x2e4d396b,"Xml.set","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",177,0x4070b816)
		HX_STACK_THIS(this)
		HX_STACK_ARG(att,"att")
...
bool Xml_obj::exists( ::String att){
	HX_STACK_FRAME("Xml","exists",0x446683b3,"Xml.exists","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",199,0x4070b816)
	HX_STACK_THIS(this)
	HX_STACK_ARG(att,"att")
	HX_STACK_LINE(200)
	int tmp = this->nodeType;		HX_STACK_VAR(tmp,"tmp");
...
Dynamic Xml_obj::attributes( ){
	HX_STACK_FRAME("Xml","attributes",0x1ab5462e,"Xml.attributes","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",209,0x4070b816)
	HX_STACK_THIS(this)
	HX_STACK_LINE(210)
	int tmp = this->nodeType;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(210)
...
Dynamic Xml_obj::elements( ){
	HX_STACK_FRAME("Xml","elements",0x0310ffce,"Xml.elements","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",229,0x4070b816)
	HX_STACK_THIS(this)
	HX_STACK_LINE(230)
	{
		HX_STACK_LINE(230)
	...
	HX_STACK_LINE(231)
	{
		...
		HX_STACK_LINE(231)
		Array< ::Dynamic > _g = tmp1;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(231)
		{
			HX_STACK_LINE(231)
			int _g1 = (int)0;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(231)
			Array< ::Dynamic > tmp2 = this->children;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(231)
			Array< ::Dynamic > _g2 = tmp2;		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(231)
			while((true)){
				HX_STACK_LINE(231)
				...
				HX_STACK_LINE(231)
				::Xml tmp5 = _g2->__get(_g1).StaticCast< ::Xml >();		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(231)
				::Xml child = tmp5;		HX_STACK_VAR(child,"child");
				HX_STACK_LINE(231)
				++(_g1);
				HX_STACK_LINE(231)
				int tmp6 = child->nodeType;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(231)
	...
	HX_STACK_LINE(231)
	Array< ::Dynamic > ret = tmp;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(232)
	Dynamic tmp1 = ret->iteratorFast< ::Xml >();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(232)
	return tmp1;
}
...
Dynamic Xml_obj::elementsNamed( ::String name){
	HX_STACK_FRAME("Xml","elementsNamed",0x6b28f50b,"Xml.elementsNamed","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",239,0x4070b816)
	HX_STACK_THIS(this)
		...
		HX_STACK_LINE(241)
		{
			...
			while((true)){
				...
				if ((tmp8)){
					...
					{
						HX_STACK_LINE(241)
						int tmp11 = child->nodeType;		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(241)
						...
						if ((tmp16)){
							HX_STACK_LINE(241)
							::String tmp17 = (HX_HCSTRING("Bad node type, expected Element but found ","\xd8","\x90","\x8b","\xbb") + child->nodeType);		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(241)
...
::Xml Xml_obj::firstElement( ){
	HX_STACK_FRAME("Xml","firstElement",0xc103a583,"Xml.firstElement","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",256,0x4070b816)
	HX_STACK_THIS(this)
	HX_STACK_LINE(257)
	{
		HX_STACK_LINE(257)
	...
	HX_STACK_LINE(258)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(258)
			::Xml tmp3 = _g1->__get(_g).StaticCast< ::Xml >();		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(258)
			::Xml child = tmp3;		HX_STACK_VAR(child,"child");
			HX_STACK_LINE(258)
			++(_g);
			HX_STACK_LINE(259)
			int tmp4 = child->nodeType;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(259)
...
{
		HX_STACK_FRAME("Xml","addChild",0x3e639952,"Xml.addChild","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",270,0x4070b816)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(271)
		{
		...
		HX_STACK_LINE(272)
		bool tmp = (x->parent == hx::ObjectPtr<OBJ_>(this));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(272)
		if ((tmp)){
			HX_STACK_LINE(273)
			return null();
			...
			HX_STACK_LINE(274)
			bool tmp1 = (x->parent != null());		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(274)
			if ((tmp1)){
				HX_STACK_LINE(275)
				::Xml tmp2 = x;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(275)
				x->parent->removeChild(tmp2);
			}
		}
		HX_STACK_LINE(277)
		Array< ::Dynamic > tmp1 = this->children;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(277)
		::Xml tmp2 = x;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(277)
		tmp1->push(tmp2);
...
bool Xml_obj::removeChild( ::Xml x){
	HX_STACK_FRAME("Xml","removeChild",0x9bd39581,"Xml.removeChild","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",285,0x4070b816)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_LINE(286)
	{
...
::Xml Xml_obj::parse( ::String str){
	HX_STACK_FRAME("Xml","parse",0x8a44f23c,"Xml.parse","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",43,0x4070b816)
...
::Xml Xml_obj::createElement( ::String name){
	HX_STACK_FRAME("Xml","createElement",0x97359a29,"Xml.createElement","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",104,0x4070b816)
	HX_STACK_ARG(name,"name")
	HX_STACK_LINE(105)
...
::Xml Xml_obj::createPCData( ::String data){
	HX_STACK_FRAME("Xml","createPCData",0x3cc9ead0,"Xml.createPCData","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",113,0x4070b816)
...
::Xml Xml_obj::createCData( ::String data){
	HX_STACK_FRAME("Xml","createCData",0xaf49365a,"Xml.createCData","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",122,0x4070b816)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(123)
...
::Xml Xml_obj::createComment( ::String data){
	HX_STACK_FRAME("Xml","createComment",0x125165cc,"Xml.createComment","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",131,0x4070b816)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(132)
...
::Xml Xml_obj::createDocType( ::String data){
	HX_STACK_FRAME("Xml","createDocType",0x696de8bf,"Xml.createDocType","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",140,0x4070b816)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(141)
...
::Xml Xml_obj::createProcessingInstruction( ::String data){
	HX_STACK_FRAME("Xml","createProcessingInstruction",0x632a1f28,"Xml.createProcessingInstruction","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",149,0x4070b816)
	HX_STACK_ARG(data,"data")
	HX_STACK_LINE(150)
...
::Xml Xml_obj::createDocument( ){
	HX_STACK_FRAME("Xml","createDocument",0xcf00030e,"Xml.createDocument","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/Xml.hx",158,0x4070b816)
	HX_STACK_LINE(159)
