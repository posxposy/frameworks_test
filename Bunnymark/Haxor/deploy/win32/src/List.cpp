...
{
HX_STACK_FRAME("List","new",0xed890070,"List.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/List.hx",41,0xcba84771)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(41)
	this->length = (int)0;
...
::_List::ListIterator List_obj::iterator( ){
	HX_STACK_FRAME("List","iterator",0x2d4cdfde,"List.iterator","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/List.hx",161,0xcba84771)
	HX_STACK_THIS(this)
	HX_STACK_LINE(162)
	Dynamic tmp = this->h;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(162)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(List_obj,h),HX_HCSTRING("h","\x68","\x00","\x00","\x00")},
