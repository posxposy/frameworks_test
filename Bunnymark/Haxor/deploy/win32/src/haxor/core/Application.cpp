...
{
HX_STACK_FRAME("haxor.core.Application","new",0xa1b5acbf,"haxor.core.Application.new","haxor/core/Application.hx",19,0xf410b3f1)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(19)
	super::__construct();
...
void Application_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("haxor.core.Application","\x4d","\xe1","\x9a","\x2f");
