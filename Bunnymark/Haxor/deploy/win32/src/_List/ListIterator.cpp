...
Void ListIterator_obj::__construct(Dynamic head)
{
HX_STACK_FRAME("_List.ListIterator","new",0x1ee472af,"_List.ListIterator.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/List.hx",244,0xcba84771)
HX_STACK_THIS(this)
...
hx::ObjectPtr< ListIterator_obj > ListIterator_obj::__new(Dynamic head)
...
bool ListIterator_obj::hasNext( ){
	HX_STACK_FRAME("_List.ListIterator","hasNext",0x25781b3c,"_List.ListIterator.hasNext","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/List.hx",249,0xcba84771)
	HX_STACK_THIS(this)
	HX_STACK_LINE(250)
	Dynamic tmp = this->head;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(250)
...
Dynamic ListIterator_obj::next( ){
	HX_STACK_FRAME("_List.ListIterator","next",0xe8ffe7c4,"_List.ListIterator.next","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/List.hx",253,0xcba84771)
	HX_STACK_THIS(this)
	HX_STACK_LINE(254)
	Dynamic tmp = this->head;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(254)
	...
	this->val = tmp1;
	HX_STACK_LINE(255)
	Dynamic tmp2 = this->head;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(255)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(ListIterator_obj,head),HX_HCSTRING("head","\x20","\x29","\x0b","\x45")},
