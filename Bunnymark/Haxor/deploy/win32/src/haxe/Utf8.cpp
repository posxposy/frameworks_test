...
{
HX_STACK_FRAME("haxe.Utf8","new",0x67cc940b,"haxe.Utf8.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/haxe/Utf8.hx",29,0x49739d74)
HX_STACK_THIS(this)
HX_STACK_ARG(size,"size")
{
	...
	if ((tmp2)){
		HX_STACK_LINE(32)
		Array< int > tmp3 = this->__s;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(32)
		int tmp4 = (size - (int)1);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(32)
		tmp3[tmp4] = (int)0;
	}
}
...
{
		HX_STACK_FRAME("haxe.Utf8","addChar",0x9a1816c2,"haxe.Utf8.addChar","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/haxe/Utf8.hx",35,0x49739d74)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(36)
		Array< int > tmp = this->__s;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(36)
...
::String Utf8_obj::toString( ){
	HX_STACK_FRAME("haxe.Utf8","toString",0xb459e121,"haxe.Utf8.toString","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/haxe/Utf8.hx",39,0x49739d74)
	HX_STACK_THIS(this)
	HX_STACK_LINE(40)
...
{
		HX_STACK_FRAME("haxe.Utf8","iter",0x67f2370d,"haxe.Utf8.iter","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/haxe/Utf8.hx",55,0x49739d74)
		HX_STACK_ARG(s,"s")
...
int Utf8_obj::length( ::String s){
	HX_STACK_FRAME("haxe.Utf8","length",0x88322e1b,"haxe.Utf8.length","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/haxe/Utf8.hx",74,0x49739d74)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(75)
	Array< int > tmp = ::__hxcpp_utf8_string_to_char_array(s);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(75)
