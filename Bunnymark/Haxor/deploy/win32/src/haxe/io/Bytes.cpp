...
{
HX_STACK_FRAME("haxe.io.Bytes","new",0x3938d57d,"haxe.io.Bytes.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",33,0xd5f63ea2)
HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",133,0xd5f63ea2)
	HX_STACK_THIS(this)
...
::String Bytes_obj::getString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",357,0xd5f63ea2)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(359)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",416,0xd5f63ea2)
	HX_STACK_THIS(this)
	HX_STACK_LINE(433)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",455,0xd5f63ea2)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(465)
	Array< unsigned char > tmp = Array_obj< unsigned char >::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(465)
	Array< unsigned char > a = tmp;		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(466)
	bool tmp1 = (length > (int)0);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(466)
	if ((tmp1)){
		HX_STACK_LINE(466)
		Array< unsigned char > tmp2 = a;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(466)
	...
	HX_STACK_LINE(467)
	::haxe::io::Bytes tmp2 = ::haxe::io::Bytes_obj::__new(length,a);		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(467)
	return tmp2;
}
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/io/Bytes.hx",482,0xd5f63ea2)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(493)
	Array< unsigned char > tmp = Array_obj< unsigned char >::__new();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(493)
	...
	HX_STACK_LINE(495)
	::haxe::io::Bytes tmp1 = ::haxe::io::Bytes_obj::__new(a->length,a);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(495)
	return tmp1;
}
