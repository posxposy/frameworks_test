...
{
		HX_STACK_FRAME("haxe.Log","trace",0x5d6e40b3,"haxe.Log.trace","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/haxe/Log.hx",45,0x2b160dd4)
		HX_STACK_ARG(v,"v")
		...
		if ((tmp1)){
			...
			HX_STACK_LINE(75)
			{
				...
				HX_STACK_LINE(75)
				Dynamic _g1 = infos->__Field(HX_HCSTRING("customParams","\xd7","\x51","\x18","\xed"), hx::paccDynamic );		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(75)
				while((true)){
					HX_STACK_LINE(75)
