...
{
HX_STACK_FRAME("sys.net._Socket.SocketOutput","new",0x717472d4,"sys.net._Socket.SocketOutput.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",80,0x7f91ea07)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(80)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeByte",0xbfd704fb,"sys.net._Socket.SocketOutput.writeByte","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",83,0x7f91ea07)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(84)
...
int SocketOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketOutput","writeBytes",0x1c4d5718,"sys.net._Socket.SocketOutput.writeBytes","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",96,0x7f91ea07)
	HX_STACK_THIS(this)
	...
	HX_STACK_CATCHABLE(Dynamic, 0);
	{
		...
		HX_STACK_LINE(98)
		Array< unsigned char > tmp2 = buf->b;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(98)
		int tmp3 = pos;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(98)
		int tmp4 = len;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(98)
		tmp = ::sys::net::_Socket::SocketOutput_obj::socket_send(tmp1,tmp2,tmp3,tmp4);
	}
	}
	catch(Dynamic __e){
		{
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketOutput","close",0xbcc83f2c,"sys.net._Socket.SocketOutput.close","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",107,0x7f91ea07)
		HX_STACK_THIS(this)
		HX_STACK_LINE(108)
		this->super::close();
		HX_STACK_LINE(109)
