...
{
HX_STACK_FRAME("sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",31,0x7f91ea07)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(31)
...
int SocketInput_obj::readByte( ){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",34,0x7f91ea07)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",47,0x7f91ea07)
	HX_STACK_THIS(this)
	...
	HX_STACK_CATCHABLE(Dynamic, 0);
	{
		...
		Dynamic tmp2 = this->__s;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(52)
		Array< unsigned char > tmp3 = buf->b;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(52)
		int tmp4 = pos;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(52)
		int tmp5 = len;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(52)
		int tmp6 = ::sys::net::_Socket::SocketInput_obj::socket_recv(tmp2,tmp3,tmp4,tmp5);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(52)
		r = tmp6;
	}
	}
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","F:\\development\\resource\\platform\\haxe\\3-2-0\\haxe\\std/cpp/_std/sys/net/Socket.hx",64,0x7f91ea07)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
		this->super::close();
		HX_STACK_LINE(66)
